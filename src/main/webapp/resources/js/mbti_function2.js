...
$('#button-result').on('click', function () {
    if ($.validation()) {
        ...
        // $('#result').html(`<P>당신의 MBTI 타입은!!<br><a href="mbtiType/${char_all.toLowerCase()}.html">${char_all}</a></p>`);
        $('#result').html(`<P>당신의 MBTI 타입은!!<br><a href="javascript:void(0);">${char_all}</a></p>`);
    }
});
